...
export default function Fomo() {
  return (
    <div className="relative w-full mx-auto  text-white px-4">
      ...
      <div className="absolute inset-0 h-full w-full rounded-3xl xl:px-30 lg:px-10 px-4 overflow-visible">
        <img
          src={BannerImg}
          alt="."
      ...
      <div className="relative p-8 md:pt-16 pb-16 h-full w-full">
        ...
        <div className="mb-4 text-center">
          <h1 className="lg:text-4xl md:text-2xl text-xl font-semibold leading-tight mb-2 max-w-full text-wrap">
            Stay stuck in survival... or bloom into your next life.
          </h1>
          <p className="md:text-xl text-base mt-5 md:mt-0 opacity-90">
        ...
        <div className="flex flex-row flex-wrap gap-20 justify-center md:my-30 my-12 md:px-18 px-4">
          ...
          <div className="relative max-w-md">
            <div className="absolute text-8xl font-bold opacity-40 -left-6 -top-10 text-white z-0">
              1
            </div>
        ...
        <div className="text-center md:mt-8 mt-4 flex justify-center">
          <div className="bg-[#E16B33] text-white w-fit font-medium py-3 px-6 rounded-md transition-colors text-sm md:text-base">
